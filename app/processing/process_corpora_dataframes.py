def process_corpora_dataframes(input_gz_json_files_dir:str, df_output_dir:str, log_flow:list, start=None, end=None):
    ...
    all_files = [f"{os.path.join(input_gz_json_files_dir, file)}" for file in os.listdir(input_gz_json_files_dir)]
    ...
    try:
        for file in tqdm(all_files):
            try:
                ...
                log_flow.append(LogString('danger', f'Ошибка в процессе обработки данных\n⤷{e_1}\n'))
